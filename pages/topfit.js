...
import store from "../public/assets/topfit.png";
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="websites, web designers" />
      ...
      <div className="w-full overflow-hidden">
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
          <div className="col-span-4">
            ...
            <p>
              This is a car dealership web application, where customers can
              browse and see which cars are available at the dealership, they
              can filter using car prices, brands, and model of cars.
            </p>
